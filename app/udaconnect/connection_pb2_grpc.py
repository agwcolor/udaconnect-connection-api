...
class ConnectionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Create = channel.unary_unary(
                ...
                response_deserializer=connection__pb2.ConnectionMessage.FromString,
                )
...
def add_ConnectionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Create': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=connection__pb2.ConnectionMessage.SerializeToString,
            ),
...
class ConnectionService(object):
    ...
    def Create(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ConnectionService/Create',
            ...
            connection__pb2.ConnectionMessage.FromString,
